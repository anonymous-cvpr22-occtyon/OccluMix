...
warp_model.eval()
warp_model.cuda()
load_checkpoint(warp_model, '/data/GDUT_student/chen_yang/PF-AFN-main_XP/PF-AFN_test/checkpoints/PFAFN_warp_epoch.pth')

gen_model = ResUnetGenerator(7, 4, 5, ngf=64, norm_layer=nn.BatchNorm2d)
print(gen_model)
gen_model.eval()
gen_model.cuda()
load_checkpoint(gen_model,  '/data/GDUT_student/chen_yang/PF-AFN-main_XP/PF-AFN_test/checkpoints/PFAFN_gen_epoch.pth')

comp_mask_model = UNet1(in_channels=22)
load_checkpoint(comp_mask_model , '/data/GDUT_student/chen_yang/PF-AFN-main_XP/PF-AFN_test/checkpoints/comp_mask_epoch.pth')
comp_mask_model .eval()
comp_mask_model .cuda()

comp_occu_model = UNet2(in_channels=22)
load_checkpoint(comp_occu_model , '/data/GDUT_student/chen_yang/PF-AFN-main_XP/PF-AFN_test/checkpoints/comp_sleeve_epoch.pth')
